...
delitos_data <- delitos_data[delitos_data$dpto_ccdgo == c ('05'), ]
dim(delitos_data)
...
ggplot(delitos_data, aes(x = sum_24HP)) +
  ...
  # Labels and title
  labs(title = "Histogram of hurto a personas with Median, and 1MAD Range",
       x = "AUTOMOTORES Values", y = "Frequency") +
...
$\text{sum\_24TR} = \sum_{i=1}^{12} \beta_i \cdot X_i$
